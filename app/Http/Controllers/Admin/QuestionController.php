        ...
        try {
            ...
            foreach ($questions as $k => $question) {
                ...
                if($question->is_approve == 2){
                    ...
                    . '<a href="javaScript:void(0);" class="btn btn-danger btn-xs reject_ques" id="' . $question->id . '" data-status="' . $question->is_approve .'"><i class="fa fa-thumbs-down"></i> Reject </a>';
                }
                $questionsArray[$k]['action'] = '<a href="' . route('admin.question.edit', $question) . '" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>&nbsp;&nbsp;&nbsp;<a href="' . route('admin.question.comment-list', $question) . '" class="btn btn-success btn-xs"><i class="fa fa-comment"></i> Comment </a>&nbsp;&nbsp;&nbsp;'
