            ...
            <div class="col-xs-12">
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Test Series Edit</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form class="form-horizontal form-label-left" action="{{ route('admin.test-series.edit', $series) }}" method="post" id="userForm" enctype="multipart/form-data">
                        @csrf
