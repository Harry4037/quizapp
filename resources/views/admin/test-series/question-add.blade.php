        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form class="form-horizontal form-label-left" action="{{ route('admin.test-series.add-question', $testseries) }}" method="post" id="quizForm" enctype="multipart/form-data">
                            @csrf
                            <div class="box-body">
            ...
            if (days > 0) {
                for (i = 0; i < days; i++) {
                    ...
                    var day_html = '<div class="box-footer">'
                            ...
                            + '<div class="col-md-4 col-sm-6 col-xs-6">'
                            + '<select class="form-control" name="time[' + i + ']">'
