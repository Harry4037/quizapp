        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-info">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form class="form-horizontal form-label-left" action="{{ route('admin.subject.edit', $subject) }}" method="post" id="subjectForm" enctype="multipart/form-data">
                        @csrf
...
<script>
    $(document).ready(function () {
        ...
        $(document).on('keydown', "#subject_name", function (e) {
