<div class="box-body">
    ...
    <div class="form-group">
        ...
        <div class="col-md-6 col-sm-8 col-xs-8">
        <input type="text" class="form-control" name="mobile" id="mobile" value="@if(isset($cms)){{$cms->mobile}}@endif" >
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-md-4 col-sm-4 col-xs-12">Email <span class="error">*</span></label>
        <div class="col-md-6 col-sm-8 col-xs-8">
        <input type="email" class="form-control" name="email" id="email" value="@if(isset($cms)){{$cms->email}}@endif" >
        </div>
    </div>
    @endif
</div>
